...
const LIB_LIST = ['Kiddo_v5_immutable_mveb', 'Kiddo_v5_immutable', 'Kiddo_v3_immutable', 'Kiddo_v3_std', 'Kiddo_v2', 'Kiddo_v1', 'FNNTW', 'pykdtree', 'nabo', 'sklearn', 'scipy'];

const LIB_COLOUR_MAP: Dict<string> = {
    'Kiddo_v5_immutable_mveb': 'magenta',
    'Kiddo_v5_immutable': 'peachpuff',
